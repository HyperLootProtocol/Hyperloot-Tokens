...
const HLPMTToken = artifacts.require('HLPMTTokenMock.sol');
...
contract('ERC721Token', function (accounts) {
  ...
  const name = "HyperLoot Protocol Mining Token";
  const symbol = "HLPMT";


  beforeEach(async function () {
    this.token = await HLPMTToken.new(holder1, holder2, { from: creator });
  });
